...
public:
    ...
    // Copy helpers
    static void copyToRegistration(const qualifiers::Player players[], int count, Player out[]);
    static void copyToQualifiers(const Player players[], int count, qualifiers::Player out[]);
